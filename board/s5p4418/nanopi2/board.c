...
*/
static int lcd_id_fun(void){
	int gpiob27 = -1, gpiob30 = -1 ,gpiob31 = -1;
	gpio_request((PAD_GPIO_B + 27),"gpiob27");
	gpio_request((PAD_GPIO_B + 30),"gpiob30");
	gpio_request((PAD_GPIO_B + 31),"gpiob31");
	gpio_direction_input((PAD_GPIO_B + 27));
	gpio_direction_input((PAD_GPIO_B + 30));
	gpio_direction_input((PAD_GPIO_B + 31));
	gpiob27 = gpio_get_value((PAD_GPIO_B + 27));
	gpiob30 = gpio_get_value((PAD_GPIO_B + 30));
	gpiob31 = gpio_get_value((PAD_GPIO_B + 31));
	gpio_free((PAD_GPIO_B + 27));
	gpio_free((PAD_GPIO_B + 30));
	gpio_free((PAD_GPIO_B + 31));
	printf("gpiob27 = %d , gpiob30 = %d ,gpiob31 = %d\n",gpiob27<<2,gpiob30<<1,gpiob31);
	return ((gpiob27<<2)|(gpiob30<<1)|gpiob31);
}
...
//	myid = 99;
	...
	if (myid <= 0 || ret != myid) {
		printf("LCD  = N/A (%d)\n", myid);
		nanopi2_setup_lcd_by_name("BP101");
